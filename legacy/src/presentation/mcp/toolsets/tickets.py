...
def register_ticket_tools(server: FastMCP, service: TicketService) -> None:
    @server.tool(structured_output=False, name="openvas_list_tickets")
    def list_tickets(filter: str = "") -> dict[str, Any]:
        return service.list(filter).model_dump()

    @server.tool(structured_output=False, name="openvas_get_ticket")
    def get_ticket(ticket_id: str) -> dict[str, Any]:
        return service.get(ticket_id).model_dump()

    @server.tool(structured_output=False, name="openvas_create_ticket")
    ...
    @server.tool(structured_output=False, name="openvas_update_ticket")
    ...
    @server.tool(structured_output=False, name="openvas_delete_ticket")
